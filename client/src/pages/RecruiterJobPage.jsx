        ...
        {!jobId ? (
          <>
            ...
            <form
              ...
              className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700 space-y-6"
            >
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl focus:outline-none focus:border-blue-500 transition-colors cursor-pointer"
                >
                  <option value="Short (15 min)">
                    Short (15 min) - Quick screening
                  </option>
                  <option value="Standard (30 min)">
                    Standard (30 min) - Balanced interview
                  </option>
                  <option value="Deep Dive (60 min)">
                    Deep Dive (60 min) - Comprehensive assessment
                  </option>
                </select>
              </div>
