  ...
  const features = [
    {
      ...
      description:
        "AI extracts your skills and experience to personalize interview questions",
      color: "blue",
    },
    {
      icon: Mic,
      ...
      description:
        "Natural conversation with AI-powered voice responses using edge-tts",
      color: "purple",
    },
    {
      icon: BarChart3,
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
          Upload your resume, get interviewed by AI, and receive instant
          feedback.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-br ${colorClasses[feature.color]} flex items-center justify-center mb-6`}
                >
          ...
          {[
            {
              step: "1",
              title: "Upload Resume",
              desc: "PDF resume gets analyzed by AI in seconds",
            },
            {
              step: "2",
              title: "Voice Interview",
              desc: "Answer questions tailored to your experience",
            },
            {
              step: "3",
              title: "Get Report Card",
              desc: "Receive detailed feedback and scores",
            },
          ].map((item) => (
            <div
              key={item.step}
              className="flex items-start gap-6 bg-gray-800/30 rounded-xl p-6 border border-gray-700/50"
            >
      ...
      <footer className="border-t border-gray-800/50 py-8">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-500 text-sm">
          <p>
            Built with Groq API, edge-tts, and React • Open Source • Free
            Forever
          </p>
        </div>
      </footer>
