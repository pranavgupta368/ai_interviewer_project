...
const InterviewRoom = ({
  ...
  const handleEndInterview = async () => {
    ...
    try {
      ...
      const response = await axios.post("/api/interview/analyze", payload);
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400">
              Professional assessment session. Speak clearly and concisely.
            </p>
          </div>
      ...
      <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
        ...
        <p className="text-sm font-medium text-gray-400">
          {isRecording ? (
            ...
            <span className="text-purple-400">Processing audio...</span>
          ) : (
