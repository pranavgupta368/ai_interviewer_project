...
const ReportCard = ({ analysis, onClose }) => {
  ...
  const getOverallRating = (score) => {
    if (score >= 90)
      return { text: "Outstanding", color: "text-green-400", emoji: "🌟" };
    if (score >= 75)
      return { text: "Great", color: "text-blue-400", emoji: "🎯" };
    if (score >= 60)
      return { text: "Good", color: "text-yellow-400", emoji: "👍" };
    if (score >= 40)
      return { text: "Fair", color: "text-orange-400", emoji: "📈" };
